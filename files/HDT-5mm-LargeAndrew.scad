...
teeth = 219;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
...
motor_shaft = 16;	// NEMA17 motor shaft exact diameter = 5
m3_dia = 5.2;		// 3mm hole diameter
...
pulley_b_dia = 60;	// pulley base diameter, standard = 20
